cordova.define("cordova-k-acc.ACC_Cordova", function (require, exports, module) {
    /*
    ...
    */
    ...
    var ACC_Cordova = (function () {
        ...
        ACC_Cordova.registerDevice = function (token, userInfo, success, fail) {
            ...
            return exec(success, fail, PLUGIN_NAME, FUNCTION_NAME, [token, userInfo]);
        };
